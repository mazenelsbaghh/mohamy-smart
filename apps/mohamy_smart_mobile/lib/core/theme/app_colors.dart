...
class AppColors {
  ...
  static const Color primaryBronze = Color(0xFF885200); // bronze highlight color for light mode
  ...
  static const Color lightBorder = Color(0x1A1B1B1B); // --border-color (rgba(27, 27, 27, 0.1))
  static const Color lightBorderStrong = Color(0x291B1B1B); // --border-strong (rgba(27, 27, 27, 0.16))
  static const Color lightAccentSoft = Color(0x1FEF950A); // --accent-soft (rgba(239, 149, 10, 0.12))
  static const Color lightAccentSoftStrong = Color(0x2EEF950A); // --accent-soft-strong (rgba(239, 149, 10, 0.18))
  ...
  static const Color lightOverlay = Color(0x6B5C533F); // --overlay-color (rgba(92, 83, 63, 0.42))
  ...
  static const Color darkTextHex = Color(0xA6FFFFFF); // --text-color (#FFFFFFA6)
  ...
  static const Color darkBorder = Color(0x17FFFFFF); // --border-color (rgba(255, 255, 255, 0.09))
  static const Color darkBorderStrong = Color(0x29FFFFFF); // --border-strong (rgba(255, 255, 255, 0.16))
  static const Color darkAccentSoft = Color(0x29EF950A); // --accent-soft (rgba(239, 149, 10, 0.16))
  static const Color darkAccentSoftStrong = Color(0x3DEF950A); // --accent-soft-strong (rgba(239, 149, 10, 0.24))
  ...
  static const Color darkOverlay = Color(0x8C000000); // --overlay-color (rgba(0, 0, 0, 0.55))
