...
class DemoLegalRepository {
  ...
  late final List<InternalRegulation>
  internalRegulations = <InternalRegulation>[
    ...
    const InternalRegulation(
      ...
      summary:
          'مبادئ توجيهية لصياغة المذكرات وتأسيس العقود القانونية وتنسيق الدفوع والطلبات.',
      sections: [
    ...
    const InternalRegulation(
      ...
      summary:
          'شروط خصم نقاط الذكاء الاصطناعي وتجديد الباقات والمستندات المدعومة.',
      sections: [
  ...
  static final Map<String, List<WorkflowStepDef>> workflowSteps = {
    'defense-memo': const [
      WorkflowStepDef(
        ...
        description: 'استخلاص الوقائع ومطابقتها قانونياً',
      ),
      WorkflowStepDef(
        index: 2,
        title: 'الدفوع',
        description: 'استخراج الدفوع الإجرائية والموضوعية والمستندية',
      ),
      WorkflowStepDef(
        index: 3,
        title: 'الطلبات',
        description: 'صياغة الطلبات النهائية الموجهة للمحكمة',
      ),
      WorkflowStepDef(
        index: 4,
        title: 'المذكرة النهائية',
        description: 'تجميع المذكرة وصياغتها بالكامل',
      ),
    ],
    'preparing-statement-of-claims': const [
      WorkflowStepDef(
        index: 1,
        title: 'نوع الدعوى',
        description: 'تحديد التصنيف الدقيق للدعوى القضائية',
      ),
      WorkflowStepDef(
        index: 2,
        title: 'الأطراف',
        description: 'بيانات المدعي والمدعى عليه في الخصومة',
      ),
      WorkflowStepDef(
        index: 3,
        title: 'الموضوع',
        description: 'تحديد عنوان ومحور النزاع الرئيسي',
      ),
      WorkflowStepDef(
        index: 4,
        title: 'الوقائع',
        description: 'الصياغة الواقعية المنظمة للأحداث',
      ),
      WorkflowStepDef(
        index: 5,
        title: 'الأساس القانوني',
        description: 'الأسانيد والمواد القانونية المنظمة للنزاع',
      ),
      WorkflowStepDef(
        index: 6,
        title: 'الطلبات',
        description: 'تحديد الطلبات الرئيسية والفرعية المدعى بها',
      ),
      WorkflowStepDef(
        index: 7,
        title: 'الصحيفة',
        description: 'تجميع صحيفة الدعوى متكاملة ومعدّة للطباعة',
      ),
    ],
    'appeal-brief': const [
      WorkflowStepDef(
        index: 1,
        title: 'بيانات الحكم',
        description: 'إدخال معلومات المحكمة ومنطوق الحكم الصادر',
      ),
      WorkflowStepDef(
        index: 2,
        title: 'تحليل الأسباب',
        description: 'استخراج عيوب التدليل والقصور في الحكم',
      ),
      WorkflowStepDef(
        index: 3,
        title: 'أوجه الطعن',
        description: 'صياغة أسباب الطعن بالاستئناف بالنقاط',
      ),
      WorkflowStepDef(
        index: 4,
        title: 'الطلبات',
        description: 'تحديد الطلبات الختامية في الاستئناف',
      ),
      WorkflowStepDef(
        index: 5,
        title: 'السند القانوني',
        description: 'الأسانيد والمواد القانونية التي تدعم الطعن',
      ),
      WorkflowStepDef(
        index: 6,
        title: 'صحيفة الاستئناف',
        description: 'تجميع صحيفة الاستئناف متكاملة ومعدّة للطباعة',
      ),
    ],
    'admin-complaint': const [
      WorkflowStepDef(
        index: 1,
        title: 'بيانات الجهة والأساس',
        description: 'تحديد الجهة الإدارية والأساس القانوني',
      ),
      WorkflowStepDef(
        index: 2,
        title: 'سرد الوقائع',
        description: 'تفصيل وقائع الشكوى بالتسلسل الزمني',
      ),
      WorkflowStepDef(
        index: 3,
        title: 'تحليل المخالفات',
        description: 'تحديد المخالفات الإدارية المرتكبة',
      ),
      WorkflowStepDef(
        index: 4,
        title: 'صياغة الطلبات',
        description: 'تحديد طلبات المتظلم الإدارية والمالية',
      ),
      WorkflowStepDef(
        index: 5,
        title: 'الشكوى النهائية',
        description: 'تجميع الشكوى النهائية متكاملة ومعدّة للطباعة',
      ),
    ],
    'ruling-analysis': const [
      WorkflowStepDef(
        index: 1,
        title: 'منطوق الحكم',
        description: 'تحليل منطوق الحكم والقرارات الصادرة',
      ),
      WorkflowStepDef(
        index: 2,
        title: 'أسباب الحكم',
        description: 'دراسة تسبيب الحيثيات والحجج القانونية',
      ),
      WorkflowStepDef(
        index: 3,
        title: 'تقييم العيوب',
        description: 'تقييم الثغرات والعيوب المؤثرة في الحكم',
      ),
      WorkflowStepDef(
        index: 4,
        title: 'خلاصة الطعن',
        description: 'تقييم فرص قبول الطعن والتوصيات النهائية',
      ),
    ],
    'legal-warning': const [
      WorkflowStepDef(
        index: 1,
        title: 'تصنيف الإنذار',
        description: 'تحديد نوع ومضمون الإنذار ومحله',
      ),
      WorkflowStepDef(
        index: 2,
        title: 'صياغة المتن',
        description: 'صياغة تفاصيل الإنذار والمهلة الممنوحة للوفاء',
      ),
      WorkflowStepDef(
        index: 3,
        title: 'الإنذار النهائي',
        description: 'تجميع الإنذار بصيغته النهائية المعدة للمحضرين',
      ),
    ],
    'exec-request': const [
      WorkflowStepDef(
        index: 1,
        title: 'تصنيف الطلب',
        description: 'تحديد تصنيف الطلب والمستند التنفيذي والجهة',
      ),
      WorkflowStepDef(
        index: 2,
        title: 'صياغة المبررات',
        description: 'كتابة أسباب ومبررات طلب التنفيذ العاجل',
      ),
      WorkflowStepDef(
        index: 3,
        title: 'الطلب النهائي',
        description: 'تجميع طلب التنفيذ بصيغته النهائية وطلبات الحجز',
      ),
    ],
  };
    ...
    mockSnapshots.addAll([
      ...
      WorkflowSnapshot(
        ...
        outputs: const {
          1: {
            'verdictPoints': [
              'إلزام المدعى عليه بدفع مبلغ ١٠٠ ألف ريال سعودي للمدعي.',
            ],
            'verdictSummary':
                'قضت المحكمة الابتدائية بإلزام موكلنا جزئياً بالمبلغ المالي المدعى به.',
          },
        },
      ),
    ]);
  ...
  static Map<String, Map<int, Map<String, dynamic>>> getMockOutputs(
    String caseTitle,
    String caseNumber,
    String court,
  ) {
    return {
      'defense-memo': {
        1: {
          ...
          'defendantsPositions': [
            {
              ...
              'positionSummary':
                  'الإنكار التام لكافة الاتهامات المنسوبة والتمسك بانتفاء الصلة بالواقعة.',
            },
          ],
          'evidenceMap': [
            {
              ...
              'doesNotProve':
                  'أي إدانة أو اشتراك للمتهم في تزوير أختام الشهر العقاري.',
          ...
          'potentialLegalCharacterization': {
            'chargeDescription':
                'التزوير في محررات رسمية واستعمالها مع العلم بتزويرها.',
            'elementsReliedUpon': ['صفة المحرر الرسمي', 'تغيير الحقيقة'],
            'elementsLackingProof': [
              'الركن المادي (القيام بالتزوير)',
          ...
          'finalPrayers': [
            {
              ...
              'requestLevel': 'أصلي',
              'requestText':
                  'أولاً وقبل كل شيء: القضاء ببراءة المتهم من كافة الاتهامات المنسوبة إليه.',
            },
            {
              'id': 'p-2',
              'requestLevel': 'احتياطي',
              'requestText':
                  'ثانياً وبصفة احتياطية: رفض الدعوى المدنية وإلزام رافعيها بالمصروفات.',
            },
          ],
        },
        4: {
          'introduction':
              'السيد رئيس المحكمة الموقرة والسادة الأعضاء الاجلاء، نقدم لعدالتكم مذكرة بدفاع المتهم في القضية رقم $caseNumber المقيدة أمام محكمتكم الموقرة $court.',
          'factualBasis':
              'تتلخص وقائع القضية في اتهام موكلنا بالتزوير بناءً على محضر محرر من جهة الإدارة.',
          'legalTextsFull': [
            {
              'lawName': 'قانون العقوبات',
              'articleNumber': '٢١١',
              'fullText':
                  'كل صاحب وظيفة عمومية ارتكب في أثناء تأدية وظيفته تزويراً في أحكام صادرة...',
            },
          ],
          'legalTextsUnavailableReason': '',
          'linkingTextsToFacts':
              'حيث أن موكلنا لم يقم بأي تغيير للحقيقة ولم يثبت تقرير الطب الشرعي وجود أي كتابة بخطه.',
          'cassationPrecedentsFull': [
            {
              ...
              'fullText':
                  'من المقرر أن التزوير لا يقوم إلا إذا ثبت تغيير الحقيقة بفعل المتهم بالذات أو باشتراكه.',
            },
          ],
          'cassationPrecedentsUnavailableReason': '',
          'counterArgumentsAndResponse':
              'رداً على مزاعم النيابة العامة، فإن الدليل الفني قد أثبت براءة موكلنا.',
          'legalEffectOfAcceptance':
              'يترتب على قبول الدفوع الحكم ببراءة المتهم وسقوط التهمة الجنائية.',
          'strengthsAndRisks':
              'نقاط القوة: تقرير الطب الشرعي قاطع. نقاط المخاطرة: احتمال طلب النيابة إعادة استجواب شهود الإثبات.',
          'documentText':
              'بموجب وكالتنا عن المتهم، نتشرف بتقديم مذكرة دفاعنا هذه:\nأولاً: الدفوع الشكلية:\n١. نتمسك بالدفع بعدم الاختصاص المحلي للمحكمة طبقاً لنص المادة ٢٧ مرافعات.\nثانياً: الدفوع الموضوعية:\n١. انتفاء الركن المادي والمعنوي لجريمة التزوير وخلو الأوراق من دليل قاطع.\nلذا نلتمس الحكم ببراءة المتهم ورفض الدعوى المدنية.',
        },
      },
      'preparing-statement-of-claims': {
        1: {
          ...
          'justificationSummary':
              'مطالبة عادية بالتعويض لعدم تسليم المجمع العقاري.',
        },
        2: {
          'caseId': 'case-claim-$caseNumber',
          'parties': [
        ...
        3: {
          'caseId': 'case-claim-$caseNumber',
          'subjectTitle':
              'المطالبة بفسخ عقد المقاولة المؤرخ في ٢٠٢٤ والتعويض عن التأخير',
          'subjectFullText':
              'تفاصيل ومضمون المطالبة القضائية بفسخ العقد المبرم والتعويض عن الأضرار الناشئة عن التأخير لعدم تسليم الوحدات في المواعيد المقررة.',
        },
        4: {
          'factsNarrative':
              'تتلخص الوقائع في قيام موكلنا بإبرام عقد مقاولة مع الشركة المدعى عليها لتشييد مجمع سكني، إلا أن الأخيرة تأخرت في تسليم مراحل البناء لأكثر من عام دون مبرر قانوني، مما كبد موكلنا خسائر فادحة.',
        },
        5: {
          'caseId': 'case-claim-$caseNumber',
          'legalTexts': [
            {
              ...
              'articleNumber': '١٠٧',
              'articleText':
                  'إذا لم يوفِ المدين بالتزامه بعد إعذاره جاز للدائن أن يطلب فسخ العقد.',
              'applicationNotes':
                  'المدعي قام بإعذار المدعى عليه رسمياً بموجب خطاب مسجل.',
            },
            {
              'id': 'lt-2',
              'lawName': 'نظام المعاملات المدنية',
              'articleNumber': '٢٢٣',
              'articleText':
                  'التعويض عن الضرر يشمل ما لحق الدائن من خسارة وما فاته من كسب.',
              'applicationNotes':
                  'الأضرار المادية الناتجة عن تعطل تشغيل المجمع العقاري.',
            },
          ],
          'cassationRulings': [
            {
              ...
              'rulingText':
                  'التأخير في تسليم العين محل عقد المقاولة دون عذر يبرر الفسخ مع التعويض.',
              'applicationNotes':
                  'يدعم أحقية موكلنا في فسخ العقد دون الإخلال بحقه بالتعويض.',
            },
          ],
        },
        6: {
          ...
          'principalRequests': [
            {
              ...
              'requestNumber': 1,
              'requestText':
                  'القضاء بفسخ عقد المقاولة المؤرخ في ٢٠٢٤ وإخلاء موقع العمل.',
            ...
            },
            {
              ...
              'requestNumber': 2,
              'requestText':
                  'إلزام المدعى عليها بدفع تعويض قدره نصف مليون جنيه عن الأضرار اللاحقة.',
      ...
      'appeal-brief': {
        1: {
          ...
          'courtInformation':
              'حكم صادر بجلسة الاستماع المنعقدة بتاريخ ١٥ يناير ٢٠٢٥ في الاستئناف رقم ٧٧٢.',
          'parties': 'شركة النور ضد شركة النخبة',
          'verdict': 'إلزام المدعى عليه بدفع تعويض وقدره ١٠٠ ألف جنيه.',
        },
        2: {
          'analysis':
              'شاب الحكم المستأنف القصور البالغ في التسبيب، حيث أغفل الرد على الدفع الجوهري المبدى بسقوط الحق بالتقادم الحولي التجاري، ومخالفته الثابت بالمستندات رقم ٣.',
          'legalFlaws': [
        ...
        4: {
          ...
          'proceduralRequests': [
            'طلب وقف تنفيذ الحكم المطعون فيه بصفة مستعجلة.',
          ],
      ...
      'admin-complaint': {
        1: {
          ...
          'legalBasis':
              'المادة رقم ١٢ من اللائحة التنفيذية لقانون الاستثمار والضمانات الممنوحة للمستثمرين.',
        },
        2: {
          'factsSummary':
              'تظلم موكلنا ضد امتناع الهيئة عن إصدار ترخيص التشغيل النهائي للمصنع العقاري رغم استيفاء كامل شروط الأمن والسلامة والموافقات البيئية اللازمة.',
          'keyFacts': [
        ...
        3: {
          'violations': [
            {
              'description':
                  'مخالفة قرار رئيس الوزراء رقم ١٢ لتبسيط إجراءات التراخيص الصناعية.',
              'legalRef': 'قرار رئيس الوزراء رقم ١٢ لسنة ٢٠٢٣ المادة الرابعة',
            },
            {
              'description':
                  'إساءة استعمال السلطة والتعسف الإداري دون إبداء أسباب مكتوبة.',
              'legalRef':
                  'المادة رقم ٢٠ من قانون الخدمة المدنية ولائحته التنفيذية',
            },
          ],
        },
        4: {
          'requests': [
            'قبول التظلم شكلاً واستيفاء الترخيص فوراً.',
            'وقف تنفيذ القرار السلبي مؤقتاً لحين الفصل النهائي.',
          ],
        },
        5: {
          'documentText':
              'إلى السيد رئيس الهيئة العامة للاستثمار،\nتحية طيبة وبعد،\nمقدمه لسيادتكم تظلم شركة النور للتجارة ضد القرار السلبي بالامتناع عن الترخيص.\nحيث أننا استوفينا كافة المتطلبات ولم يتم تسليم التراخيص.\nلذا نرجو التفضل بإصدار التوجيهات للترخيص السريع.',
        },
      },
      'ruling-analysis': {
        1: {
          'verdictPoints': [
            'إلزام المدعى عليه بدفع مبلغ ١٠٠ ألف ريال سعودي للمدعي.',
            'إلزام المدعى عليه بالمصروفات وأتعاب المحاماة الفائتة.',
          ],
          'verdictSummary':
              'قضت المحكمة الابتدائية بإلزام موكلنا جزئياً بالمبلغ المالي المدعى به بناءً على تقرير المحاسب الاستشاري دون استجواب موكلنا.',
          'charges': ['المطالبة بقيمة توريدات كهربائية متأخرة'],
        },
        2: {
          'reasoningPoints': [
            'استندت المحكمة كلياً لنتائج تقرير الخبير الحسابي.',
            'اعتبرت المحكمة غياب موكلنا عن جلسة وحيدة بمثابة إقرار بالحق المزعوم.',
          ],
          'keyFindings': [
            'أغفلت المحكمة فحص أوراق السداد الجزئي بقيمة ٤٠ ألف ريال.',
          ],
        },
        3: {
          'defects': [
            {
              'description':
                  'الإخلال بحق الدفاع لعدم تمكين موكلنا من مناقشة تقرير الخبير.',
              'severity': 'جسيم / مؤثر جوهرياً في منطوق الحكم',
            },
            {
              'description':
                  'قصور التسبيب بمصادرة رغبة المتهم في تقديم مستندات تسوية الدفع.',
              'severity': 'متوسط / ثغرة قانونية تدعم قبول الاستئناف',
            },
          ],
        },
        4: {
          ...
          'conclusion':
              'نوصي بشدة برفع استئناف ضد هذا الحكم لوجود عيوب إجرائية فادحة وتوفر فرصة كبيرة لنقضه وإحالة الملف لخبير حسابي آخر للتأكد من تسديد الدفعات.',
        },
      },
      'legal-warning': {
        1: {
          ...
          'legalBasis': {
            ...
            'description':
                'البند السابع من اتفاقية التوريد والمادة ١٥٧ من القانون المدني المصري.',
          },
          'obligationDetails':
              'الالتزام بسداد المبلغ المتبقي وقدره ١٢٠ ألف ريال سعودي في الأجل المحدد قانوناً.',
          'recommendedAction':
              'توجيه إنذار رسمي على يد محضر لإعذار المدين وقطع التقادم قبل رفع الدعوى.',
        },
        2: {
          'warningBody':
              'بناءً على طلب موكلنا، ننذركم بضرورة سداد المبلغ المتبقي وقدره ١٢٠ ألف ريال خلال مهلة أقصاها ١٥ يوماً من تاريخ التبليغ، وإلا سنضطر لرفع دعوى الفسخ والتعويض.',
          'keyPoints': [
            'التأخر في السداد تجاوز ٣ أشهر.',
            'إثبات انتفاء الظروف الاستثنائية المانعة من السداد.',
          ],
        },
        3: {
          'documentText':
      ...
      'exec-request': {
        1: {
          ...
          'executionGrounds':
              'الحكم النهائي الصادر في الدعوى رقم ١٢٣٤ لسنة ٢٠٢٦.',
          'urgencyLevel': 'عاجل (وجود تخوف حقيقي من تهريب الأموال)',
        },
        2: {
          'requestBody':
              'نلتمس من قاضي التنفيذ قيد ملف التنفيذ وإصدار قرار المادة ٣٤ لإخطار المنفذ ضده بالوفاء خلال ٥ أيام، واتخاذ إجراءات الحجز على الأرصدة البنكية في حال امتناعه.',
          'keyArguments': [
            'الحكم نهائي وحائز على قوة الأمر المقضي به.',
            'امتناع المنفذ ضده عن السداد الودي رغم الإعذار.',
          ],
        },
        3: {
          'documentText':
              'إلى السيد قاضي التنفيذ بمحكمة التنفيذ بـ $court.\nالطالب: أحمد السالم\nالمنفذ ضده: مؤسسة توريد ومقاولات\nنقدم لعدالتكم السند التنفيذي رقم ١٢٣٤ الصادر من المحكمة التجارية.\nونرجو الأمر بالتنفيذ وإلزام المنفذ ضده بسداد المديونية وإجراء الحجز البنكي.',
        },
      },
    };
  }
