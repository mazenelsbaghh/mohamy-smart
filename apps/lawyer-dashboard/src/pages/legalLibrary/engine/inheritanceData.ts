...
export const RADD_ELIGIBLE: HeirType[] = ['DAUGHTER','SON_OF_SON','DAUGHTER_OF_SON','FULL_SISTER','PATERNAL_HALF_SISTER','MOTHER','GRANDMOTHER_PATERNAL','GRANDMOTHER_MATERNAL',
];
