...
export const WORKFLOW_TAB_CLASSNAMES = {
  ...
  tabContent: "font-bold text-[13px] app-text-subtle dark:app-text-subtle group-data-[selected=true]:text-white relative z-10",
  panel: "pt-4 pb-2 px-0",
  cursor: "w-full h-full bg-[var(--main-color)] rounded-lg shadow-none border-0",
} as const;
