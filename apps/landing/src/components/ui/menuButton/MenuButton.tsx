...
const MenuButton = ({ openNav, setOpenNav }: TMenuButton) => {
    ...
    return (
        <button
            ...
            aria-label={openNav ? 'إغلاق القائمة' : 'فتح القائمة'}
            aria-expanded={openNav}
        >
            <svg className={`ham ham3 ${openNav && 'active'}`} viewBox="0 0 100 100" width='50'>
