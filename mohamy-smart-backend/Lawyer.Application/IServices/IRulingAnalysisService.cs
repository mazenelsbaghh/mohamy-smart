...
namespace Lawyer.Application.IServices
{
    public interface IRulingAnalysisService
    {
        ...
        Task<Result<RulingAnalysisWorkflowDto>> ResumeCurrentRunAsync(Guid caseId, string lawyerId, CancellationToken ct);
        Task<Result<RulingAnalysisWorkflowDto>> AdvanceStageAsync(Guid caseId, int workflowId, int fromStep, int toStep, string lawyerId, CancellationToken ct);
