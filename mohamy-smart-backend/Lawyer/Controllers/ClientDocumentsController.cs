...
namespace Lawyer.Controllers
{
    ...
    [Authorize]
    public class ClientDocumentsController : AppControllerBase
    {
        private readonly IDocumentHandoffService _service;
        private readonly IUnitOfWork _unitOfWork;
        private readonly IValidator<CreateDocumentHandoffDto> _validator;
        private readonly ILawyerIdResolver _lawyerIdResolver;
        private readonly IUserContextProvider _userContextProvider;

        public ClientDocumentsController(IDocumentHandoffService service, IUnitOfWork unitOfWork, IValidator<CreateDocumentHandoffDto> validator, ILawyerIdResolver lawyerIdResolver, IUserContextProvider userContextProvider)
        {
            _service = service;
        ...
        public async Task<IActionResult> Create([FromForm] CreateDocumentHandoffDto dto, CancellationToken cancellationToken)
        {
